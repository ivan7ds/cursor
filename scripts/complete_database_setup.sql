...
('loc-mad-001', 'ES', 'IPD', 'Centro Comercial Plaza Norte 2', 'Plaza Norte 2, 28760 Tres Cantos', 'Tres Cantos', 'Spain', '{"latitude": 40.6011, "longitude": -3.7083}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-mad-002', 'ES', 'IPD', 'Centro Comercial La Gavia', 'Av. de las Suertes, 28047', 'Madrid', 'Spain', '{"latitude": 40.3897, "longitude": -3.6289}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-mad-003', 'ES', 'IPD', 'Centro Comercial Isla Azul', 'Calle de la Isla Azul, 28042', 'Madrid', 'Spain', '{"latitude": 40.4567, "longitude": -3.6123}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-mad-004', 'ES', 'IPD', 'Centro Comercial Plaza de Castilla', 'Plaza de Castilla, 28046', 'Madrid', 'Spain', '{"latitude": 40.4667, "longitude": -3.6897}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-mad-005', 'ES', 'IPD', 'Centro Comercial Príncipe Pío', 'Paseo de la Florida, 28008', 'Madrid', 'Spain', '{"latitude": 40.4233, "longitude": -3.7189}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Barcelona Metropolitan Area (10 locations)
('loc-bcn-001', 'ES', 'IPD', 'Centro Comercial Diagonal Mar', 'Passeig del Taulat, 08019', 'Barcelona', 'Spain', '{"latitude": 41.4089, "longitude": 2.2197}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-bcn-002', 'ES', 'IPD', 'Centro Comercial La Maquinista', 'Carrer de Josep Estivill, 08030', 'Barcelona', 'Spain', '{"latitude": 41.4456, "longitude": 2.1898}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-bcn-003', 'ES', 'IPD', 'Centro Comercial Glòries', 'Av. Diagonal, 208, 08013', 'Barcelona', 'Spain', '{"latitude": 41.4036, "longitude": 2.1897}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Valencia (5 locations)
('loc-val-001', 'ES', 'IPD', 'Centro Comercial Aqua Multiespacio', 'Carrer de Menorca, 19, 46023', 'València', 'Spain', '{"latitude": 39.4699, "longitude": -0.3763}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-val-002', 'ES', 'IPD', 'Centro Comercial Nuevo Centro', 'Carrer de Menorca, 19, 46023', 'València', 'Spain', '{"latitude": 39.4699, "longitude": -0.3763}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Sevilla (5 locations)
('loc-sev-001', 'ES', 'IPD', 'Centro Comercial Los Arcos', 'Av. de Andalucía, 1, 41007', 'Sevilla', 'Spain', '{"latitude": 37.3891, "longitude": -5.9845}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-sev-002', 'ES', 'IPD', 'Centro Comercial Nervión Plaza', 'Calle Luis Montoto, 41005', 'Sevilla', 'Spain', '{"latitude": 37.3898, "longitude": -5.9767}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Bilbao (5 locations)
('loc-bil-001', 'ES', 'IPD', 'Centro Comercial Zubiarte', 'Paseo de Uribitarte, 48001', 'Bilbao', 'Spain', '{"latitude": 43.2627, "longitude": -2.9253}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-bil-002', 'ES', 'IPD', 'Centro Comercial Max Center', 'Calle Max, 1, 48950 Erandio', 'Erandio', 'Spain', '{"latitude": 43.3123, "longitude": -2.9567}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Málaga (5 locations)
('loc-mal-001', 'ES', 'IPD', 'Centro Comercial Larios', 'Calle Larios, 29005', 'Málaga', 'Spain', '{"latitude": 36.7213, "longitude": -4.4217}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),
('loc-mal-002', 'ES', 'IPD', 'Centro Comercial Vialia', 'Estación de Málaga-María Zambrano, 29002', 'Málaga', 'Spain', '{"latitude": 36.7456, "longitude": -4.4567}', 'ON_STREET', 'Europe/Madrid', NOW(), NOW(), NOW()),

-- Lisboa (5 locations)
('loc-lis-001', 'PT', 'IPD', 'Centro Comercial Colombo', 'Av. Lusíada, 1500-392', 'Lisboa', 'Portugal', '{"latitude": 38.7223, "longitude": -9.1393}', 'ON_STREET', 'Europe/Lisbon', NOW(), NOW(), NOW()),
('loc-lis-002', 'PT', 'IPD', 'Centro Comercial Vasco da Gama', 'Av. D. João II, 1990-094', 'Lisboa', 'Portugal', '{"latitude": 38.7567, "longitude": -9.0945}', 'ON_STREET', 'Europe/Lisbon', NOW(), NOW(), NOW()),

-- Porto (5 locations)
('loc-por-001', 'PT', 'IPD', 'Centro Comercial NorteShopping', 'Rua Sara Martins de Almeida, 4460-841 Senhora da Hora', 'Senhora da Hora', 'Portugal', '{"latitude": 41.1897, "longitude": -8.6567}', 'ON_STREET', 'Europe/Lisbon', NOW(), NOW(), NOW()),
('loc-por-002', 'PT', 'IPD', 'Centro Comercial Mar Shopping', 'Rua do Mar, 4150-518', 'Porto', 'Portugal', '{"latitude": 41.1567, "longitude": -8.6234}', 'ON_STREET', 'Europe/Lisbon', NOW(), NOW(), NOW());
...
('tariff-001', 'ES', 'IPD', 'EUR', 'REGULAR', '[{"price_components": [{"type": "ENERGY", "price": 0.25, "step_size": 1}]}]', NULL, NULL, NOW(), NOW(), NOW()),
('tariff-002', 'ES', 'IPD', 'EUR', 'FAST', '[{"price_components": [{"type": "ENERGY", "price": 0.35, "step_size": 1}]}]', NULL, NULL, NOW(), NOW(), NOW()),
('tariff-003', 'PT', 'IPD', 'EUR', 'REGULAR', '[{"price_components": [{"type": "ENERGY", "price": 0.28, "step_size": 1}]}]', NULL, NULL, NOW(), NOW(), NOW());
...
('token-001', 'ES', 'IPD', 'TOKEN-001', 'RFID', 'RFID', 'CONTRACT-001', 'IPD', true, 'ALWAYS', 'es', 'REGULAR', NULL, NOW(), NOW(), NOW()),
('token-002', 'ES', 'IPD', 'TOKEN-002', 'APP_USER', 'APP_USER', 'CONTRACT-002', 'IPD', true, 'ALLOWED', 'en', 'FAST', NULL, NOW(), NOW(), NOW());
