  ...
  router.get('/evses', authMiddleware, async (_req, res) => {
    try {
      ...
      const [results] = await sequelize.query(`
            ...
            FROM external_operator_evses e
            LEFT JOIN external_operator_locations l 
                ON e.location_id = l.id 
                AND e.external_operator_party_id = l.external_operator_party_id
                AND e.external_operator_country_code = l.external_operator_country_code
