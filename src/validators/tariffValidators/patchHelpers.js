const { tariffPutPathSchema, tariffPatchBodySchema } = require('./tariffBodySchemas');

/**
 * Valida los parámetros de ruta para PATCH de Tariff
 * @param {Object} params - Parámetros de ruta
 * @returns {Object} Resultado de validación
 */
function validateTariffPatchPath(params) {
...
/**
 * Valida el body para PATCH de Tariff
 * @param {Object} body - Body de la petición
 * @returns {Object} Resultado de validación
 */
function validateTariffPatchBody(body) {
 ...
 */
function validateTariffPatchPathBodyMatch(pathParams, bodyData) {
  const matchErrors = [];
