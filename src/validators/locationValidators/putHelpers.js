const { locationPathSchema, locationPutBodySchema } = require('./locationSchemas');

/**
 * Valida los parámetros de ruta para PUT de Location
 * @param {Object} params - Parámetros de ruta
 * @returns {Object} Resultado de validación
 */
function validateLocationPutPath(params) {
...
/**
 * Valida el body para PUT de Location
 * @param {Object} body - Body de la petición
 * @returns {Object} Resultado de validación
 */
function validateLocationPutBody(body) {
 ...
 */
function validateLocationPutPathBodyMatch(pathParams, bodyData) {
  const matchErrors = [];
